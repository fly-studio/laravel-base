...
<script src="<{'js/jquery.validate.min.js'|static nofilter}>"></script>
<script src="<{'js/jquery.validate.addons.min.js'|static nofilter}>"></script>
<{/if}>
<{if !empty($errors)}>
...
<script src="<{'js/laravel.validation.min.js'|static nofilter}>"></script>
<{/if}>
